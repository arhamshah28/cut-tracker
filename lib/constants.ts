...
export const EMPTY_DAY: DayEntry = {
  meals: [],
  dinner: null,
  workout: null,
  walks: [],
...
export const WCD: Record<string, { wL: number; salt: string; note: string; calT: number }> = {
...
export const MG: Record<string, { id: string; n: string; c: number; p: number; t: string }[]> = {
  morning: [
...
export const AM = Object.values(MG).flat();
...
export const CAT_ACCENTS: Record<string, string> = {
  morning: "#d4ff3a",
  lunch: "#ffc05c",
  preworkout: "#33eeff",
  postworkout: "#60b8ff",
